...
python3 tools/eval.py -c configs/det/det_r50_vd_db.yml  -o Global.checkpoints="./output/det_r50_vd/best_accuracy" PostProcess.box_thresh=0.7 PostProcess.unclip_ratio=1.5

//Step3:测试图像
python3 tools/infer_det.py -c configs/det/det_r50_vd_db.yml -o Global.infer_img="D:/4_code/GitHub_Open/PaddleOCR/train_data/text_localization/train" Global.checkpoints="./output/det_r50_vd/best_accuracy"
